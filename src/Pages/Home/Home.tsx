    ...
    <div>
      ...
      <div className='lg:grid-cols-3 relative'>
        ...
        <div className='flex overflow-x-scroll lg:overflow-visible justify-start mt-12 pb-12'>
          <div className='xl:w-[320px] lg:w-[200px] h-[130px] min-w-[351px] lg:min-w-0 mx-5 ml-12 rounded-[10px] bg-[#fbe1ff] flex justify-center items-center lg:absolute top-[10em] '>
          ...
          <div className='xl:w-[320px] lg:w-[200px] min-w-[351px] lg:min-w-0 mx-5 h-[130px] rounded-[10px] bg-[#fbe1ff] flex justify-center items-center lg:absolute top-[50em] left-[15px] '>
          ...
          <div className='xl:w-[320px] lg:w-[200px] min-w-[351px] lg:min-w-0 mx-5 h-[130px] rounded-[10px] bg-[#fbe1ff] flex justify-center items-center lg:absolute top-[50em] left-[75%]'>
          ...
          <div className='xl:w-[320px] lg:w-[200px] min-w-[351px] lg:min-w-0 mx-5 h-[130px] rounded-[10px] bg-[#fbe1ff] flex justify-center items-center lg:absolute top-[10em] left-[75%]'>
